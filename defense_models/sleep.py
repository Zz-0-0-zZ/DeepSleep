...
class SlowSleepBlock(object):
    def __init__(self, train_loader, spike_rate=1/100, sleeplength=1):
        self.model = None
    ...
    def slowsleep(self, param):
        ...
        self.subslowsleep(self.sleeplength, self.spike_rate)
...
class SleepDefense(object):
    def __init__(self, model, train_loader):
        init_model = copy.deepcopy(model)
        self.model = init_model
        self.train_loader = train_loader

    def sleep_defence(self, spike_rate=1/100, sleeplength=1):
        dataflow = get_cnn_para(self.model)
        slow_sleep = SlowSleepBlock(self.train_loader, spike_rate=spike_rate, sleeplength=sleeplength)
...
if __name__ == '__main__':
    ...
    deepsleep = SleepDefense(model=CNN_model,train_loader=train_loader)
